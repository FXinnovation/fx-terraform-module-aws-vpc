...
variable "private_extra_subnet_suffix" {
  description = "Suffix to append to private extra subnets name"
  default     = "private-extra"
}

variable "private_extra_subnets" {
  description = "A list of private extra subnets inside the VPC"
  default     = []
}

variable "private_extra_subnet_tags" {
  description = "Additional tags for the private extra subnets"
  default     = {}
}

variable "private_extra_route_table_tags" {
  description = "Additional tags for the private extra route tables"
  default     = {}
}
...
variable "private_extra_outbound_acl_rules" {
  description = "Private extra subnets outbound network ACLs"
...
variable "cloudwatch_logs_endpoint_subnet_ids" {
  description = "The ID of one or more subnets in which to create a network interface for cloudwatch logs endpoint. If omitted, private subnets will be used."
  default     = []
}

variable "cloudwatch_logs_endpoint_private_dns_enabled" {
